...
# Created: 2024-02-06T06:51:11-07:00
#
...
#
# Usage: python3 python-ucar.cgd.ccsm4.geomip.ssp5.BWSSP585cmip6.15C.002.atm.proc.monthly_ave-20240206T0651.py
# Version: 0.1.2-alpha
#
# Dataset
# ucar.cgd.ccsm4.geomip.ssp5.BWSSP585cmip6.15C.002.atm.proc.monthly_ave
# 3a149995-4df9-43b3-aaaa-39c596910c92
# https://www.earthsystemgrid.org/dataset/ucar.cgd.ccsm4.geomip.ssp5.BWSSP585cmip6.15C.002.atm.proc.monthly_ave.html
# https://www.earthsystemgrid.org/dataset/id/3a149995-4df9-43b3-aaaa-39c596910c92.html
#
# Dataset Version
# 1
# a15a763c-5233-4448-af64-e2989833dd44
# https://www.earthsystemgrid.org/dataset/ucar.cgd.ccsm4.geomip.ssp5.BWSSP585cmip6.15C.002.atm.proc.monthly_ave/version/1.html
# https://www.earthsystemgrid.org/dataset/version/id/a15a763c-5233-4448-af64-e2989833dd44.html
#
################################################################
...
data = [
     {'url':'https://tds.ucar.edu/thredds/fileServer/datazone/cdg/data/GeoMIP-SSP5/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002/atm/proc/tseries/month_1/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.PRECT.202001-210012.nc','filename':'b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.PRECT.202001-210012.nc','bytes':'169296406','md5Checksum':''},
     {'url':'https://tds.ucar.edu/thredds/fileServer/datazone/cdg/data/GeoMIP-SSP5/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002/atm/proc/tseries/month_1/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.PS.202001-210012.nc','filename':'b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.PS.202001-210012.nc','bytes':'121615713','md5Checksum':''},
     {'url':'https://tds.ucar.edu/thredds/fileServer/datazone/cdg/data/GeoMIP-SSP5/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002/atm/proc/tseries/month_1/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.T.202001-210012.nc','filename':'b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.T.202001-210012.nc','bytes':'7830473704','md5Checksum':''},
     {'url':'https://tds.ucar.edu/thredds/fileServer/datazone/cdg/data/GeoMIP-SSP5/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002/atm/proc/tseries/month_1/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.TH.202001-210012.nc','filename':'b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.TH.202001-210012.nc','bytes':'7716767501','md5Checksum':''},
     {'url':'https://tds.ucar.edu/thredds/fileServer/datazone/cdg/data/GeoMIP-SSP5/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002/atm/proc/tseries/month_1/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.TREFHT.202001-210012.nc','filename':'b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.TREFHT.202001-210012.nc','bytes':'120096220','md5Checksum':''},
     {'url':'https://tds.ucar.edu/thredds/fileServer/datazone/cdg/data/GeoMIP-SSP5/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002/atm/proc/tseries/month_1/b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.U.202001-210012.nc','filename':'b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.feedback.15C.002.cam.h0.U.202001-210012.nc','bytes':'10715523368','md5Checksum':''},]
